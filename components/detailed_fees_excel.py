"""
Detailed Fees Excel Export Component

Generates a comprehensive Excel workbook with detailed fee calculations including:
- Methodology explanation
- Scenario configuration
- Yearly summary
- Monthly detail with all calculation steps
- Daily detail with all calculation steps
- Market returns showing individual market contributions

This component provides complete transparency for manager review and verification.
"""
...
def generate_detailed_fees_excel(
    db,
    program_id: int,
    scenario_id: int,
    output_path: str,
    ...
    **kwargs
    ...
    """
    Generate comprehensive detailed fees Excel workbook.
    ...
    Args:
        ...
        start_date: Start date (optional, defaults to program start)
        end_date: End date (optional, defaults to latest data)
